...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2023 at 11:40 AM
...
INSERT INTO `admins` (`id`, `name`, `username`, `email_verified`, `email_verify_token`, `mobile`, `email`, `image`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'admin', 'super_admin', 1, NULL, NULL, 'admin@gmail.com', NULL, '2023-10-08 06:24:19', '$2y$10$a/iVpefUma2nPqX.7MrUJO8QsgbU0JtfAuEOp4efvbdE/b56nteMO', NULL, '2023-10-01 02:54:37', '2023-10-01 02:54:37');
...
(160, '2014_10_12_100000_create_password_reset_tokens_table', 65);
...
CREATE TABLE `page_builders` (
  ...
  `addon_namespace` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
